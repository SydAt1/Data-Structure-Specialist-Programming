    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        try {
            if (searchValue.matches("\\d+")) { // If the input is numeric (Podcast ID)
                ...
                // Introduced issue: Sorting the list incorrectly by always passing an empty list
                sortedList = (ArrayList<PodcastModel>) selectionSorter.sortByPodcastId(new ArrayList<>(), false);
