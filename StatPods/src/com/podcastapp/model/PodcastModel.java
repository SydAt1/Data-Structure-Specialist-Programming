...
public class PodcastModel implements Serializable {
    ...
    /**
     * Default constructor initializing the podcast fields with default values.
     * 
     * @param podId The ID of the podcast.
     * @param podName The name of the podcast.
     * @param genre1 The genre of the podcast.
     ...
     * @param podStudio The name of the podcast studio.
     */
